        ...
        <div class="card">
            ...
            <div class="bg-white p-4 flex flex-col justify-center items-center">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('payment.instructions') }}" class="btn btn-secondary ring-1 ring-inset ring-primary">Membership</a>
                    <a href="{{route('payments.user')}}" class="btn btn-primary ring-1 ring-inset ring-primary">View Payments</a>
                </div>
            </div>
        </div>
    </div>
